      ...
      <section className="d-flex justify-items-start bg-dark border-bottom border-black">
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-1">
            ...
            {/* Grid Column */}
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4 text-white"></div>
            {/* Grid Column */}

            {/* Grid Column */}
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 text-white"></div>
            {/* Grid Column  */}
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 text-white">
              ...
              <p>
                <i class="fas fa-home me-3"></i> Indonesia, Surabaya, ID
              </p>
              <p>
              ...
              <p>
                <i class="fas fa-phone me-3"></i> + 62 081 567 488
              </p>
            </div>
            {/* Grid Column */}
          </div>
